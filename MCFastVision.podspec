#
#  Be sure to run `pod spec lint MCFastVision.podspec' to ensure this is a
...
一个基于 iOS Vision 框架的通用视觉识别工具库，封装了文字识别（OCR）、条形码/二维码识别、人脸检测、人脸关键点检测、矩形检测等能力，并提供统一的配置入口与识别结果绘制能力，支持快速集成到业务项目中，用于扫描、识别、检测与可视化标注等场景。
  ...
  spec.author             = { "MorganChen" => "cjfmail@foxmail.com" }
  # Or just: spec.author    = "Rate"
  # spec.authors            = { "Rate" => "" }
  # spec.social_media_url   = "https://twitter.com/Rate"
  ...
  spec.source       = { :git => "https://github.com/Json031/MCFastVision.git", :tag => "#{spec.version}" }
